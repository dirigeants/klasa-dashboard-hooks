...
export declare abstract class Middleware extends Piece {
     ...
     */
    constructor(store: MiddlewareStore, directory: string, file: readonly string[], options?: MiddlewareOptions);
    /**
     ...
     */
    abstract run(request: KlasaIncomingMessage, response: KlasaServerResponse, route: Route): void | Promise<void>;
}

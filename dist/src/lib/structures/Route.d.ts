...
import { ParsedPart } from '../util/Util';
...
export declare type ParsedRoute = ParsedPart[];
/**
 ...
 */
export declare class Route extends Piece {
    /**
     ...
     */
    constructor(store: RouteStore, dir: string, file: string[], options?: RouteOptions);
    /**
     * If this route matches a provided url.
     * @since 0.0.1
     * @param split the url to check
     */
    matches(split: string[]): boolean;
    /**
     * Extracts the params from a provided url.
     * @since 0.0.1
     * @param split the url
     */
    execute(split: string[]): Record<string, string>;
}
